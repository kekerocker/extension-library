...
/* https://github.com/RedMadRobot/edge-to-edge-decorator */
...
object EdgeToEdgeDecorator {
    ...
    private fun getStatusBarColor(context: Context): Int {
        ...
        return when {
            ...
            Build.VERSION.SDK_INT < Build.VERSION_CODES.M -> config.statusBarCompatibilityColor
    ...
    private fun getNavBarColor(context: Context): Int {
        ...
        return when {
            ...
            Build.VERSION.SDK_INT < Build.VERSION_CODES.O -> config.navBarCompatibilityColor
    ...
    private fun getStatusBarFlags(context: Context, @ColorInt statusBarColor: Int): Int {
        ...
        return if (needShowDarkStatusBarIcons && Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
    ...
    private fun getNavBarFlags(context: Context, @ColorInt navBarColor: Int): Int {
        ...
        return if (showDarkNavBarIcons && Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
    ...
    class DefaultConfig {
         ...
         */
        @AttrRes
        var appBarColorAttr = attr.colorPrimarySurface
